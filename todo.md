...
- [ ] Initialize Cargo workspace (core `no_std` crate + std-enabled tooling/test crates)
- [ ] Add `LICENSE-MIT` and `LICENSE-APACHE` (copyright TPT Solutions)
- [ ] Add SPDX `MIT OR Apache-2.0` headers to `Cargo.toml` and source file template
- [ ] Write `README.md` (project summary, architecture overview, license)
- [ ] Write `CONTRIBUTING.md`
- [ ] Set up CI pipeline (build, clippy/lint, test on push/PR)
